 ...
 * 
 */
@WebServiceClient(name = "MathServiceImplService", targetNamespace = "http://service.math_service.example.fadel.com/", wsdlLocation = "http://localhost:8080/mathservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MATHSERVICEIMPLSERVICE_QNAME = new QName("http://service.math_service.example.fadel.com/", "MathServiceImplService");
    ...
    public MathService getMathServiceImplPort() {
        return super.getPort(new QName("http://service.math_service.example.fadel.com/", "MathServiceImplPort"), MathService.class);
    }
    ...
    public MathService getMathServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.math_service.example.fadel.com/", "MathServiceImplPort"), MathService.class, features);
    }
